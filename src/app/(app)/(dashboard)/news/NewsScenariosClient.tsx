      ...
      <section className={gridClassName} aria-label="Escenarios de noticias">
        <article className={cardClassName}>
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <span className="inline-flex min-h-7 items-center rounded-full border border-warning/40 bg-warning/10 px-2.5 py-1 text-xs font-semibold text-warning">
        ...
        return (
          <article className={cardClassName} key={item.id}>
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <span className="inline-flex min-h-7 items-center rounded-full border border-secondary/40 bg-secondary/15 px-2.5 py-1 text-xs font-semibold text-secondary">
            ...
            <div className="grid gap-1.5 border-l-[3px] border-secondary bg-secondary/10 px-3 py-2.5">
